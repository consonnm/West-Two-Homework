                            ...
                            for (boolean useSSPS : new boolean[] { false, true }) {
                                for (boolean sendFractionalSeconds : new boolean[] { false, true }) {
                                    for (boolean sendTimeFract : new boolean[] { false, true }) {
                                        ...
                                        assertEquals(Date.from(exp_instant_tz), this.rs.getDate(1));
                                        assertEquals(Date.from(exp_instant_05), this.rs.getDate(1, cal_05));
                                        assertEquals(Time.valueOf(lt_000000), this.rs.getTime(1));
                                        assertEquals(Time.from(lt_000000.atOffset(ZoneOffset.ofHours(5)).atDate(ld_19700101).toInstant()),
                                        ...
                                        assertEquals(Date.from(exp_instant_tz), this.rs.getObject(1));
                                        assertEquals(Date.from(exp_instant_tz), this.rs.getObject(1, Date.class));
                            ...
                            for (boolean useSSPS : new boolean[] { false, true }) {
                                for (boolean sendFractionalSeconds : new boolean[] { false, true }) {
                                    for (boolean sendTimeFract : new boolean[] { false, true }) {
                                        ...
                                        assertEquals(Time.from(exp_instant_tz), this.rs.getTime(1));
                                        assertEquals(Time.from(exp_instant_05), this.rs.getTime(1, cal_05));
                                        assertEquals(Timestamp.from(exp_instant_tz), this.rs.getTimestamp(1));
                                        assertEquals(Timestamp.from(exp_instant_05), this.rs.getTimestamp(1, cal_05));
                                        assertEquals(Time.from(exp_instant_tz), this.rs.getObject(1));
                                        assertEquals(Date.valueOf(ld_19700101), this.rs.getObject(1, Date.class));
                                        assertEquals(Time.from(exp_instant_tz), this.rs.getObject(1, Time.class));
                                        assertEquals(Timestamp.from(exp_instant_tz), this.rs.getObject(1, Timestamp.class));
                                        assertEquals(java.util.Date.from(exp_instant_tz), this.rs.getObject(1, java.util.Date.class));
                                        assertEquals(exp_cal, this.rs.getObject(1, Calendar.class));
                            ...
                            for (boolean useSSPS : new boolean[] { false, true }) {
                                for (boolean sendFractionalSeconds : new boolean[] { false, true }) {
                                    for (boolean sendTimeFract : new boolean[] { false, true }) {
                                        ...
                                        assertEquals(Date.from(exp_date.toInstant()), this.rs.getDate(1));
                                        assertEquals(Date.from(exp_date_with_cal), this.rs.getDate(1, cal_05));
                                        assertEquals(Time.from(exp_time.toInstant()), this.rs.getTime(1));
                                        assertEquals(Time.from(exp_time_with_cal), this.rs.getTime(1, cal_05));
                                        ...
                                        assertEquals(Date.from(exp_date.toInstant()), this.rs.getObject(1, Date.class));
                                        assertEquals(Time.from(exp_time.toInstant()), this.rs.getObject(1, Time.class));
                            ...
                            for (boolean useSSPS : new boolean[] { false, true }) {
                                for (boolean sendFractionalSeconds : new boolean[] { false, true }) {
                                    for (boolean sendTimeFract : new boolean[] { false, true }) {
                                        ...
                                        assertEquals(Date.from(exp_date_instant_tz), this.rs.getDate(1));
                                        assertEquals(Date.from(exp_date_instant_05), this.rs.getDate(1, cal_05));
                                        assertEquals(Time.from(exp_time_instant_tz), this.rs.getTime(1));
                                        assertEquals(Time.from(exp_time_instant_05), this.rs.getTime(1, cal_05));
                                        ...
                                        assertEquals(Date.from(exp_date_instant_tz), this.rs.getObject(1, Date.class));
                                        assertEquals(Time.from(exp_time_instant_tz), this.rs.getObject(1, Time.class));
                                ...
                                for (boolean useSSPS : new boolean[] { false, true }) {
                                    for (boolean sendFractionalSeconds : new boolean[] { false, true }) {
                                        for (boolean sendTimeFract : new boolean[] { false, true }) {
                                            ...
                                            if (yearIsDateType) {
                                                assertEquals(Date.from(exp_instant_tz), rs1.getDate(1));
                                                assertEquals(Date.from(exp_instant_05), rs1.getDate(1, cal_05));
                                                ...
                                                assertEquals(Date.from(exp_instant_tz), rs1.getObject(1));
                                                assertEquals(Date.from(exp_instant_tz), rs1.getObject(1, Date.class));
                                                ...
                                                assertThrows(SQLException.class, Messages.getString("ResultSet.UnsupportedConversion",
                                                        new Object[] { "LONG", Date.class.getName() }), new Callable<Void>() {
                                                            public Void call() throws Exception {
                                                                rs1.getDate(1);
                                                                return null;
                                                            }
                                                ...
                                                assertThrows(SQLException.class, Messages.getString("ResultSet.UnsupportedConversion",
                                                        new Object[] { "LONG", Time.class.getName() }), new Callable<Void>() {
                                                            public Void call() throws Exception {
                                                                rs1.getTime(1);
                                                                return null;
                                                            }
                                                ...
                                                assertThrows(SQLException.class, Messages.getString("ResultSet.UnsupportedConversion",
                                                        new Object[] { "LONG", Timestamp.class.getName() }), new Callable<Void>() {
                                                            public Void call() throws Exception {
                                                                rs1.getTimestamp(1);
                                                                return null;
                                                            }
                                            ...
                                            assertThrows(SQLException.class, Messages.getString("ResultSet.UnableToConvertString",
                                                    new Object[] { s_2020, Date.class.getName() }), new Callable<Void>() {
                                            ...
                                            assertThrows(SQLException.class, Messages.getString("ResultSet.UnableToConvertString",
                                                    new Object[] { s_2020, Time.class.getName() }), new Callable<Void>() {
                                                        public Void call() throws Exception {
                                                            rs1.getTime(2);
                                                            return null;
                                                        }
                                            ...
                                            assertThrows(SQLException.class, Messages.getString("ResultSet.UnableToConvertString",
                                                    new Object[] { s_2020, Timestamp.class.getName() }), new Callable<Void>() {
                                                        public Void call() throws Exception {
                                            ...
                                            assertThrows(SQLException.class, Messages.getString("ResultSet.UnableToConvertString",
                                                    new Object[] { s_2020, Calendar.class.getName() }), new Callable<Void>() {
                                                        public Void call() throws Exception {
