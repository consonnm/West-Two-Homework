        ...
        try {
            if (parameterObj instanceof LocalDate) {
                ...
                switch (targetMysqlType) {
                    ...
                    case DATETIME:
                    case TIMESTAMP:
                        Timestamp ts = Timestamp.valueOf(((OffsetDateTime) parameterObj)
                ...
                switch (targetMysqlType) {
                    ...
                    case DATETIME:
                    case TIMESTAMP:
                        Timestamp ts = Timestamp.valueOf(((ZonedDateTime) parameterObj)
                ...
                switch (targetMysqlType) {
                    ...
                    case DATETIME:
                    case TIMESTAMP:
                        setTimestamp(parameterIndex, new Timestamp(((java.util.Date) parameterObj).getTime()), targetMysqlType);
                        break;
                    case YEAR:
                ...
                switch (targetMysqlType) {
                    ...
                    case LONGTEXT:
                        ...
                        int dotPos;
                        if ((((Timestamp) parameterObj).getNanos() == 0 || !this.sendFractionalSeconds.getValue())
                ...
                switch (targetMysqlType) {
                    ...
                    case DATETIME:
                    case TIMESTAMP:
                        Timestamp ts = new Timestamp(((java.sql.Time) parameterObj).getTime());
                ...
                switch (targetMysqlType) {
                    case DATE:
                        setDate(parameterIndex, new java.sql.Date(((Calendar) parameterObj).getTimeInMillis()));
                        break;
                    case DATETIME:
                    case TIMESTAMP:
                        ...
                        break;
                    case YEAR:
                        setInt(parameterIndex, ((Calendar) parameterObj).get(Calendar.YEAR));
                        break;
                    case TIME:
                        LocalTime lt = ((Calendar) parameterObj).toInstant().atZone(this.session.getServerSession().getDefaultTimeZone().toZoneId())
                                .toLocalTime();
                        setLocalTime(parameterIndex, lt, targetMysqlType);
                        break;
                    case CHAR:
                    ...
                    case LONGTEXT:
                        ZonedDateTime zdt = ZonedDateTime
                                .ofInstant(((Calendar) parameterObj).toInstant(), ((Calendar) parameterObj).getTimeZone().toZoneId())
                ...
                switch (targetMysqlType) {
                    ...
                    case DECIMAL:
                    case DECIMAL_UNSIGNED:
                        setBigDecimal(parameterIndex, new BigDecimal(((Boolean) parameterObj).booleanValue() ? 1d : 0d));
                        break;
                    case CHAR:
                    case VARCHAR:
                    case TINYTEXT:
